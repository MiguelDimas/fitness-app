...
Built as part of the **QHO656 Dissertation Project** at Southampton Solent University:
*"Design and Evaluation of an AI-Powered Gamified Fitness App for Improving Exercise Adherence."*

## Accessing the App

**Live app:** [https://fitness-app-gamma-puce.vercel.app/](https://fitness-app-gamma-puce.vercel.app/)

A demo account is provided for marking:

- **Email:** fitnessapp.demo@gmail.com
- **Password:** 123456

After logging in, enter any Participant ID (e.g. `DEMO01`) and choose a starting phase to begin exploring the app.
...
- **Study mode** — participant setup with counterbalanced phase order (Fixed first / Adaptive first) for the evaluation study.
...
**Miguel Dimas** — Southampton Solent University
Module: QHO656 Dissertation Project
Supervisor: Dr Sharjeel Aslam
